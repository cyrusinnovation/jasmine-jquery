...
var spyOnEvent = function(selector, eventName) {
  return jasmine.JQuery.events.spyOn(jQuery(selector).selector, eventName)
}
...
beforeEach(function() {
  ...
  this.addMatchers({
    toHaveBeenTriggeredOn: function(selector) {
      ...
      return jasmine.JQuery.events.wasTriggered(jQuery(selector).selector, this.actual)
    }
  })
  this.addMatchers({
  ...
  this.addMatchers({
    toHaveBeenPreventedOn: function(selector) {
      ...
      return jasmine.JQuery.events.wasPrevented(jQuery(selector).selector, this.actual)
    }
  })
  this.addMatchers({
